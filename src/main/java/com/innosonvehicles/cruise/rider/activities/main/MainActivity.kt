package com.innosonvehicles.cruise.rider.activities.main
...
import com.innosonvehicles.cruise.common.activities.chargeAccount.ChargeAccountActivity
import com.innosonvehicles.cruise.common.activities.transactions.TransactionsActivity
import com.innosonvehicles.cruise.common.activities.travels.TravelsActivity
import com.innosonvehicles.cruise.common.interfaces.AlertDialogEvent
import com.innosonvehicles.cruise.common.location.MapHelper.centerLatLngsInMap
import com.innosonvehicles.cruise.common.models.Request
import com.innosonvehicles.cruise.common.models.Service
import com.innosonvehicles.cruise.common.networking.socket.CurrentRequestResult
import com.innosonvehicles.cruise.common.networking.socket.GetCurrentRequestInfo
...
import com.innosonvehicles.cruise.common.utils.AlerterHelper.showInfo
import com.innosonvehicles.cruise.common.utils.AlerterHelper.showWarning
import com.innosonvehicles.cruise.common.utils.CommonUtils
import com.innosonvehicles.cruise.common.utils.DataBinder.setMedia
import com.innosonvehicles.cruise.common.utils.LocationHelper.Companion.DoubleArrayToLatLng
import com.innosonvehicles.cruise.common.utils.LocationHelper.Companion.LatLngToDoubleArray
import com.innosonvehicles.cruise.rider.R
import com.innosonvehicles.cruise.rider.activities.about.AboutActivity
import com.innosonvehicles.cruise.rider.activities.addresses.AddressesActivity
import com.innosonvehicles.cruise.rider.activities.coupon.CouponActivity
import com.innosonvehicles.cruise.rider.activities.looking.LookingActivity
import com.innosonvehicles.cruise.rider.activities.main.adapters.ServiceCategoryViewPagerAdapter
import com.innosonvehicles.cruise.rider.activities.main.fragments.ServiceCarousalFragment.OnServicesCarousalFragmentListener
import com.innosonvehicles.cruise.rider.activities.profile.ProfileActivity
import com.innosonvehicles.cruise.rider.activities.promotions.PromotionsActivity
import com.innosonvehicles.cruise.rider.activities.travel.TravelActivity
import com.innosonvehicles.cruise.rider.databinding.ActivityMainBinding
import com.innosonvehicles.cruise.rider.models.LocationWithName
import com.innosonvehicles.cruise.rider.models.OrderedService
import com.innosonvehicles.cruise.rider.models.RequestDTO
import com.innosonvehicles.cruise.rider.networking.socket.*
...
class MainActivity : RiderBaseActivity(), OnMapReadyCallback, OnServicesCarousalFragmentListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Marker click:
        binding.expandingMarker.setOnClickListener{
            onButtonConfirmPickupClicked()
            binding.buttonConfirmPickup.visibility = View.VISIBLE
            binding.doubleBtn.visibility = View.INVISIBLE
        }
        ...
        binding.searchPlace.setOnLeftMenuClickListener(object : OnLeftMenuClickListener {
            override fun onMenuOpened() {
                if (binding.buttonConfirmPickup.visibility == View.INVISIBLE) binding.drawerLayout.openDrawer(GravityCompat.START)
            }
...
//                    GetAddresses().executeArray<com.innosonvehicles.cruise.common.models.Address> {
//                        when (it) {
...
//                R.id.action_voice_rec -> displaySpeechRecognizer()
    ...
    private fun addDestination() {
        ...
        markers.add(mMap!!.addMarker(MarkerOptions().anchor(0.5f, 0.5f)
                ...
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.car_straight_marker))))
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap!!.setOnCameraMoveStartedListener {
            ...
            //Toast.makeText(this@MainActivity,"Called 1",Toast.LENGTH_LONG).show();
