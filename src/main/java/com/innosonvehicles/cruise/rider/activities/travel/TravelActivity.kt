package com.innosonvehicles.cruise.rider.activities.travel
...
import com.innosonvehicles.cruise.common.activities.chat.ChatActivity
...
import com.innosonvehicles.cruise.common.models.Coupon
...
import com.innosonvehicles.cruise.common.networking.socket.Cancel
...
import com.innosonvehicles.cruise.rider.activities.travel.adapters.TravelTabsViewPagerAdapter
import com.innosonvehicles.cruise.rider.activities.travel.fragments.ReviewDialog
import com.innosonvehicles.cruise.rider.activities.travel.fragments.ReviewDialog.OnReviewFragmentInteractionListener
import com.innosonvehicles.cruise.rider.activities.travel.fragments.TabStatisticsFragment.OnTravelInfoReceived
import com.innosonvehicles.cruise.rider.databinding.ActivityTravelBinding
import com.innosonvehicles.cruise.rider.networking.socket.EnableVerification
import com.innosonvehicles.cruise.rider.networking.socket.ReviewDriver
            ...
            Request.Status.DriverAccepted, Request.Status.Started -> {
                ...
                if (driverLocation != null) {
                    ...
                    if (driverMarker == null) {
                        driverMarker = gMap!!.addMarker(MarkerOptions().position(driverLocation!!).icon(BitmapDescriptorFactory.fromResource(R.drawable.car_straight_marker)))
                    } else {
